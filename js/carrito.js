...
//Espero a que todos los elementos de la pagina carguen para ejecutar el script
...
function ready(){
    ...
    for(var i=0;i<botonesSumarCantidad.length; i++){
     ...
     //funcionalidad boton restar cantidad
...
//Funcion que controla el boton clickado de agregar al carrito
...
function agregarItemAlCarrito(titulo, precio, imagenSrc){
    ...
    //controla que el item que intenta añadir no esta ya en el carrito
...
function actualizarTotalCarrito(){
    ...
    for(var i=0; i< carritoItems.length;i++){
        ...
        //quita el simbolo euro y el punto si lo llevara.
